...
namespace Movements.Data.Migrations
{
    ...
    [Migration("20220204010232_adiss")]
    partial class adiss
    {
            ...
            modelBuilder.Entity("Movements.Domain.Entities.Movement", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            MovimentDate = new DateTime(2022, 2, 3, 22, 2, 31, 639, DateTimeKind.Local).AddTicks(8846),
                            UserCode = "TESTE",
                            Value = 10000
                        });
                });
            ...
            modelBuilder.Entity("Template.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2022, 2, 3, 22, 2, 31, 638, DateTimeKind.Local).AddTicks(8833),
                            CreatedUser = 1,
                        ...
                        {
                            Id = 2,
                            CreatedDate = new DateTime(2022, 2, 3, 22, 2, 31, 639, DateTimeKind.Local).AddTicks(6643),
                            CreatedUser = 1,
